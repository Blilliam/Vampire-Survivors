...
public class Exp extends Entity {
	...
	public Exp(GameObject gameObj, int value, int x, int y) {
		...
		hitBox.add(x - gameObj.getCameraX() - width / 2, y - gameObj.getCameraY() - height / 2); // top left

		hitBox.add(x - gameObj.getCameraX(), y - gameObj.getCameraY() - height / 2); // top right

		hitBox.add(x - gameObj.getCameraX(), y - gameObj.getCameraY()); // bottom right

		hitBox.add(x - gameObj.getCameraX() - width / 2, y - gameObj.getCameraY()); // bottom left
	...
	public void update() {
		...
		if (Entity.polygonCollision(this, gameObj.getPlayer())) {
